...
viewof reaction = Inputs.button(html`<button style="color: black; background-color: lightgray;">Roll on Table</button>`, {value: 0, reduce: () => highlightTableRowRet("#reaction-roll", generalTableSelect2([1,20,0],[[1,1], [2,2],[3,6],[7,8],[9,12],[14,19],[20, 20]]))})
md`1d20: ${reaction}`
```
