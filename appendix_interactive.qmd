...
viewof goldRoll = Inputs.button(html`<button style="color: black; background-color: lightgray;">Roll Gold (2d6 x 5)</button>`, {value: 0, reduce: () => {
  let temp = (5 * generalDice(2,6,0));
