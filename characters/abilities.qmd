...
**Strength:** This ability measures the character's raw physical power. Strength is the Prime Requisite for [Fighters](class.qmd#fighter). Apply the ability bonus or penalty for Strength to all melee attack rolls in combat. See the [Combat](../combatDetails.qmd#damage) section for details.
