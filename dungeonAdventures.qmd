...
As described in the [Equipment](./characters/equipment.qmd) section, normal characters must consume one day's worth of rations (or equivalent food) and at least one quart of water per day.
...
A careful character might choose to listen at a door before opening it. Anybody can hear noise on successful Perception check DC 15. Dwarves, Elves, & Half-Elves have an additional +1 to hear noise. Thieves have a special ability, [Listen](./characters/class.qmd#listen), which should be applied if the listener is a Thief. 
...
Normal characters can detect traps on a successful DC 17 + Investigation Skill bonus. Thieves have a special ability to [find and remove traps](./characters/class.qmd#findremove-traps). 
