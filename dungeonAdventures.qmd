...
As described in the [Equipment](./02-characters/equipment.qmd) section, normal characters must consume one day's worth of rations (or equivalent food) and at least one quart of water per day.
...
Normal characters can detect traps on a successful DC 17 + Investigation Skill bonus. Thieves have a special ability to [find and remove traps](./02-characters/class.qmd#findremove-traps). 
