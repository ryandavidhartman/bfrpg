...
| Druid Level | 1^st^    | 2^nd^    | 3^rd^    | 4^th^       | 5^th^  | 9^th^  | 12^th^        | 15^th^      |
|-------------|----------|----------|----------|-------------|--------|--------|---------------|-------------|
...
| Neutral   | Bravo     | Duelist   | Sellsword | Swordsmen     | Swordsmaster  | Champion         | Warchief        | Chieftain             |
| Chaotic   | Brawler   | Raider    | Marauder  | Ravager       | Reaver        | Warmonger        | Warlord         | Overlord              |
: Fighter Titles {#tbl-titles-figthers}
:::
