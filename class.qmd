...
If the result on the table results in automatically befriending the animals, the DM should treat the animals as if a “Friendly,” result was rolled on the Reaction Roll Table. A Befriended animal will follow the Druid, guarding and assisting within its capabilities so long as the Druid remains in the general vicinity of its normal lair or range. 
However, it will not fight to the death or sacrifice itself indiscriminately. When substantially wounded, an animal will flee the area immediately. The DM may [check morale](combatDetails.qmd#morale) as necessary when the situation seems appropriate.
...
Magic-Users trained at the Great School of Magic will recognize certain arcane symbols representing the four basic elements.

![](images/elementalSymbols.png)

Classically trained Magic-Users will also be familar with the runes identifying potions created by the Master Alchemist of the School of Magic.  Kappiyan Flurmastyr is the current Master Alchemist.
