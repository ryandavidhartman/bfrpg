...
Almost all potions are created by Kappiyan Flurmastyr, master alchemist from Glantry. The glass bottles bear his symbol: a large circle, within which is a triangle, containing a square, within which is a circle. An additional [symbol](./02-characters/05-Classes.qmd#arcane-symbols) indicates the nature of the potion.
...
This glass jar, 3 inches in diameter, contains 1d4 + 1 doses of a thick mixture that smells faintly of aloe. As an action, one dose of the ointment can be swallowed or applied to the skin. The creature that receives it regains 2d8 + 2 hit points, ceases to be [poisoned](healingAndInjuries.qmd#poisoned), and is cured of any [disease](healingAndInjuries.qmd#diseased). The ointment will remove scars and reattach knocked out teeth.
...
to a permanent form of the spell [ESP](allSpells.qmd#esp); it is
...
mind reading/ESP. Other characters who are within 30' of
...
image. No sound will be heard normally. **Detect magic, detect evil, and ESP** have a 3%
...
the [ESP](allSpells.qmd#esp) spell which has a range of 90 feet
...
These soft boots enable the wearer to move quietly in virtually any surroundings, granting a DC 9 (- Dex bonus) chance of success (Like a 8^th^ level [Thief](./02-characters/05-Classes.qmd#thief-abilities)).
...
Appearing as a normal helmet, this helm grants its wearer the ability to understand the spoken words of any creature and to read text in any language, including magical writing. The wearer of this helm can also use arcane scrolls with the same proficiency as a 7th-level [thief](./02-characters/05-Classes.qmd#thief-abilities) (DC 7).
...
The deep pocket has a few limitations:
- Overloading it or piercing it with a sharp object destroys it.
- If destroyed, its contents are lost forever, though an artifact lost this way may reappear elsewhere.
- Turning it inside out spills its contents unharmed; it must be corrected before use.

If a living creature is placed within the pocket, it can survive for up to 10 minutes before beginning to suffocate. Placing the deep pocket inside an extradimensional space created by a [bag of holding](magicItems.qmd#bag-of-holding), [portable hole](magicItems.qmd#portable-hole), or similar item instantly destroys both items, creating a gate to the [Astral Sea](planes.qmd#astral-sea). The gate opens where one item was placed inside the other. Creatures within 10 feet of the gate are drawn through and deposited randomly on the [Astral Sea](planes.qmd#astral-sea) before the gate closes. The gate is one-way and cannot be reopened.

### Medallion of ESP

This pendant disk, typically made from bronze, copper, or nickel and worn on a neck chain, allows the wearer to read the thoughts of others, similar to the spell [ESP](allSpells.qmd#esp). The medallion can be used as many times per day as desired. However, each use requires at least 1 round of full concentration to activate, and the wearer must maintain concentration to sustain the effect.

### Mirror of Life Trapping


This magical device appears as a large mirror of various styles, framed in metal or wood. It can be hung or placed on a surface and activated by speaking a [command word](magicItems.qmd#using-magic-items) followed by "activate" or "deactivate." Only a Magic-User can properly control this device. The same command word deactivates the mirror, and the character who activated it is immune to its effects.
...
Placing a portable hole inside an extradimensional space created by a [bag of holding](magicItems.qmd#bag-of-holding), [magical deep pocket](magicItems.qmd#magical-deep-pocket), or similar item instantly destroys both items, opening a gate to the [Astral Sea](planes.qmd#astral-sea) where the items were intermingled. Creatures within 10 feet of the gate are drawn through to a random location on the [Astral Sea](planes.qmd#astral-sea), after which the gate closes. The gate is one-way and cannot be reopened.
...
This device appears as a silver medallion shaped like a beetle. The scarab absorbs [energy-draining attacks](healingAndInjuries.qmd#energy-drain), [death effects](allSpells.qmd#death-spell), and [curses](allSpells.qmd#remove-curse). After absorbing 2d6 such attacks, it crumbles to dust and is destroyed.
...
A stone of this nature is typically an oddly shaped piece of roughly polished rock. By uttering a few words of summoning that require 1 full round to speak, the possessor can summon a Huge [earth elemental](monstersAll.qmd#elemental-earth). Only one elemental can be summoned per day, and it follows the commands of the summoner.
...
Additionally, you can command a [bolt of lightning](allSpells.qmd#lightning-bolt) to leap from the sphere's center toward a creature of your choice within 60 feet, dealing 5d6 lightning damage.

### Thunderstone

This stone can be thrown as a ranged attack with a range increment of 30 feet. Upon striking a hard surface or being struck hard, it emits a deafening bang treated as a sonic attack. Creatures within a 10-foot-radius spread must make a DC 16 Constitution saving throw or be deafened for 1 hour. [Deafened](healingAndInjuries.qmd#deafness) creatures suffer a -4 penalty on Initiative and have a 20% chance to miscast any spell with a verbal component.