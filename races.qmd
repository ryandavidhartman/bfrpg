...
**Special Abilities:** Halflings are unusually accurate with all sorts of ranged weapons, gaining a +1 attack bonus when employing them. When attacked in melee by creatures larger than man-sized, Halflings gain a +2 bonus to their Armor Class. Halflings are quick-witted, thus adding +1 to [Initiative](combatDetails.qmd#initiative) die rolls. Halflings can hide in shadows indoors like the [Thief](class.qmd#thief) ability and hide outdoors like the [Ranger](class.qmd#ranger) ability of the same level.
