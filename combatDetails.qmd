...
[Fighters](./characters/class.qmd#fighter), [Rangers](./characters/class.qmd#ranger), and [Paladins](./characters/class.qmd#paladin) start with 4 weapon proficiencies and gain 1 weapon proficiency every other level after 1st (1 at 3rd, 1 at 5th, 1 at 7th, etc.). Only true Fighters can also specialize in a weapon.

[Clerics](./characters/class.qmd#cleric) start with 3 weapon proficiencies and gain 1 weapon proficiency every 3 levels (1 at 4th, 1 at 7th, etc.). Clerics may wear any armor and have no weapon restrictions.

[Druids](./characters/class.qmd#druids) start with 3 weapon proficiencies and gain 1 weapon proficiency every 4 levels (1 at 5th, 1 at 9th, etc.). Druids may not utilize metal armor of any type and are likewise limited to wooden shields. Druids may utilize any one-handed melee weapons, as well as staff, sling, and short bow.

[Thieves](./characters/class.qmd#thief) start with 3 weapon proficiencies and gain 1 weapon proficiency every 3 levels (1 at 4th, 1 at 7th, etc.). Thieves may wear leather armor without penalty to thieving abilities and have no weapon restrictions. The Assassins' Assassinate attack must be carried out with a one-handed piercing weapon, such as a dagger or sword.

[Magic Users](./characters/class.qmd#magic-user) start with 2 weapon proficiencies and gain no new proficiencies as they spend most of their training time studying books and not practicing with weapons.
...
If an attack hits, the attacker rolls damage as given for the weapon. Melee attacks apply the [Strength](./characters/abilities.qmd#ability-scores) bonus or penalty to the damage dice, as do thrown missile weapons such as daggers or spears. Usually, attacks with bows or crossbows do not gain the Strength bonus, but sling bullets or stones do.
...
As [explained elsewhere](./characters/hitPoints.qmd#unconscious), a creature or character reduced to 0 hit points is unconscious, and dying when they have negative hit points.
...
Attacks made from behind an opponent usually receive a +2 attack bonus. This does not combine with the [Sneak Attack](./characters/class.qmd#thief-abilities) ability.
