...
[Roll 3d6](appendix_interactive.qmd#character-abilities) for each ability score.  Assign the results to each ability, described in the [Character Abilities](abilities.qmd#ability-scores) section, as desired.
...
![Character Information](./images/charactersheet.png){#fig-char-info}
