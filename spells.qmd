...
Each casting of the spell removes a single negative level from a creature who has suffered energy drain. At 16^th^ level, two negative levels may be removed. See the rules for Energy Drain (in the [Encounter](combat.html#energy-drain) section) for more details.
