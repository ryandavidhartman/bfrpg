...
This spell creates a sickly stinking smell of rot and decay that emanates from the caster's body.  The stench duplicates the sickening effect of ghasts ([see its entry in the Basic Fantasy Field Guide 1](monstersAll.html#ghoul-and-ghast)).  The smell of death and corruption surrounding the caster is so overwhelming that living creatures within 10 feet must succeed a save vs. Poison or be sickened for 2d6 rounds (-2 to attack rolls). 
