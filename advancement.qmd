...
Experience points are given for monsters defeated, and for other challenges as the DM sees fit. The following table provides XP values for monsters. Where a monster has both a character level and hit dice given, use the larger value as the monster's level. Non-combat challenges may be assigned a level, or a flat XP value assigned, as the DM wishes.
...
No character may advance more than one level due to the experience points from a single adventure. For example, Barthal the Thief is 1^st^ level and has 1,000 XP before going on an adventure; during the adventure, he earns 2,000 more XP (an amazing feat). This would make his total 3,000 XP, and he would be a 3^rd^ level Thief. This is not allowed; instead, he advances to 2,499 XP, one short of the amount required for 3^rd^ level, and starts his next adventure at 2^nd^ level.
