...
viewof click = Inputs.button(html`<button style="color: black; background-color: lightgray;">Roll 1d4</button>`, {value: 0, reduce: () => rolld4()})
```
...
viewof gemJewel3 = Inputs.button(html`<button style="color: black; background-color: lightgray;">Roll on Table</button>`, {value: 0, reduce: () => highlightTableRow("#confusion-table", confusionTable())})
