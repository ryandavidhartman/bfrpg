...
viewof mreaction = Inputs.button(html`<button style="color: black; background-color: lightgray;">Roll on Table</button>`, {value: 0, reduce: () => highlightTableRowRet("#monster-reaction", generalTableSelect2([2,6,0],[[2,2],[3,7],[8,11],[12,12]]))})
md`2d6: ${mreaction}`
```
